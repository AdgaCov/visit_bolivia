...
$app->group('/api/cities', function (RouteCollectorProxy $group) {
    $group->get('', [LocationController::class, 'index'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'city']));
        return $next($request, $response);
    });
    $group->get('/nearby', [LocationController::class, 'getNearby'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'city']));
        return $next($request, $response);
    });
    $group->get('/search', [LocationController::class, 'search'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'city']));
        return $next($request, $response);
    });
    $group->get('/by-department/{department_id}', [LocationController::class, 'getByDepartment'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'city']));
        return $next($request, $response);
    });
    $group->get('/{id}', [LocationController::class, 'show']);
    $group->group('', function (RouteCollectorProxy $protected) {
        $protected->post('', [LocationController::class, 'store'])->add(function($request, $response, $next) {
...
$app->group('/api/places', function (RouteCollectorProxy $group) {
    ...
    $group->get('/by-user/{user_id}', [LocationController::class, 'getByUser'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'attraction']));
        return $next($request, $response);
    });
    $group->get('/by-subcategory/{subcategory_id}', [LocationController::class, 'getBySubcategory'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'attraction']));
        return $next($request, $response);
    });
    $group->get('/{id}', [LocationController::class, 'show']);
...
$app->group('/api/events', function (RouteCollectorProxy $group) {
    ...
    $group->get('/stats', [LocationController::class, 'getStats'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'event']));
        return $next($request, $response);
    });
    $group->get('/by-type/{type}', [LocationController::class, 'getByType'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'event']));
        return $next($request, $response);
    });
    $group->get('/{id}', [LocationController::class, 'show']);
...
$app->group('/api/accommodations', function (RouteCollectorProxy $group) {
    ...
    $group->get('/by-badge/{badge}', [LocationController::class, 'getByType'])->add(function($request, $response, $next) {
        $request = $request->withQueryParams(array_merge($request->getQueryParams(), ['type' => 'accommodation']));
        return $next($request, $response);
    });
