<template>
  <component :is="linkComponent" v-bind="linkProps" class="gastronomy-card">
    <div class="gastronomy-image">
      <div class="gastronomy-image-media" :style="{ backgroundImage: `url(${image})` }" />
      <!-- <div class="gastronomy-badge">{{ badge }}</div> -->
    </div>
    <div class="gastronomy-content">
      <!-- <div class="gastronomy-icon">
        <i class="fas fa-utensils"></i>
      </div> -->
      <h3 class="gastronomy-title">{{ title }}</h3>
      <div class="gastronomy-meta">
        <span><i class="fas fa-map-marker-alt me-1"></i>{{ location }}</span>
        <span><i class="fas fa-star ms-3 me-1"></i>{{ rating }}</span>
      </div>
      <p class="gastronomy-description">{{ description }}</p>
    </div>
  </component>
</template>
...
.gastronomy-card:hover .gastronomy-image-media { 
  transform: scale(1.05); 
}

.gastronomy-card:hover .gastronomy-image { 
...
.gastronomy-card:hover .gastronomy-image::after {
  opacity: 1;
}
